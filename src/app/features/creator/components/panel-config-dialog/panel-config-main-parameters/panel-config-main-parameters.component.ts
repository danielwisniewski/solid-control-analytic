...
@Component({
  selector: 'app-panel-config-main-parameters',
  templateUrl: './panel-config-main-parameters.component.html',
  styleUrls: ['./panel-config-main-parameters.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PanelConfigMainParametersComponent {
