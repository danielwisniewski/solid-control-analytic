...
export class MainLayoutComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    this.body = (<HTMLElement>this.element.nativeElement).querySelector(
      'body'
    )!;
    this.mainPanel! = (<HTMLElement>this.element.nativeElement).querySelector(
      'main-panel'
    )!;
    this.navbarMinimize! = (<HTMLElement>this.element.nativeElement).querySelector(
